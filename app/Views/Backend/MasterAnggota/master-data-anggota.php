            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <h3>Master Data Anggota
                        <a href="<?php echo base_url('admin/input-data-anggota');?>"><button type="button" class="btn btn-sm btn-primary pull-right">Input Data Anggota</button></a>
                    </h3>
                    <hr />
                    <table data-toggle="table" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-pagination="true">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url('admin/edit-data-anggota/').sha1($data['id_anggota']);?>"><button type="button" class="btn btn-sm btn-success">Edit</button></a>
